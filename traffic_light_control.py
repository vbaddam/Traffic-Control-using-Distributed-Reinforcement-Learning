...
class SumoIntersection:
    ...
    def step(self,):
        ...
        if(action == 0 and light[0][0][0] == 0):
                ...
                for i in range(6):
                    stepz += 1
                    traci.trafficlight.setPhase('gneJ15', 1)
                    waiting_time += (traci.edge.getLastStepHaltingNumber('a') + traci.edge.getLastStepHaltingNumber(
                        'c') + traci.edge.getLastStepHaltingNumber('e') + traci.edge.getLastStepHaltingNumber('g'))
                for i in range(10):
                    stepz += 1
                    traci.trafficlight.setPhase('gneJ15', 2)
                    waiting_time += (traci.edge.getLastStepHaltingNumber('a') + traci.edge.getLastStepHaltingNumber(
                        'c') + traci.edge.getLastStepHaltingNumber('e') + traci.edge.getLastStepHaltingNumber('g')+traci.edge.getLastStepHaltingNumber('f') + traci.edge.getLastStepHaltingNumber(
                        'k') + traci.edge.getLastStepHaltingNumber('i') + traci.edge.getLastStepHaltingNumber('m'))
                    traci.simulationStep()
                for i in range(6):
                    stepz += 1
                    traci.trafficlight.setPhase('gneJ15', 3)
                    waiting_time += (traci.edge.getLastStepHaltingNumber('a') + traci.edge.getLastStepHaltingNumber(
                        'c') + traci.edge.getLastStepHaltingNumber('e') + traci.edge.getLastStepHaltingNumber('g')+traci.edge.getLastStepHaltingNumber('f') + traci.edge.getLastStepHaltingNumber(
                        'k') + traci.edge.getLastStepHaltingNumber('i') + traci.edge.getLastStepHaltingNumber('m'))
                    traci.simulationStep()
                ...
                for i in range(10):
                    stepz += 1
                    traci.trafficlight.setPhase('gneJ15', 4)
                    reward1 += traci.edge.getLastStepVehicleNumber(
                        '1si') + traci.edge.getLastStepVehicleNumber('2si')
                    reward2 += traci.edge.getLastStepHaltingNumber(
                        '3si') + traci.edge.getLastStepHaltingNumber('4si')
            ...
            if(action == 0 and light[0][0][0] == 1):
                ...
                for i in range(10):
                    stepz += 1
                    traci.trafficlight.setPhase('gneJ151', 4)
                    reward1 += traci.edge.getLastStepVehicleNumber(
                        '1si') + traci.edge.getLastStepVehicleNumber('2si')
                    reward2 += traci.edge.getLastStepHaltingNumber(
                        '3si') + traci.edge.getLastStepHaltingNumber('4si')
            ...
            if(action == 1 and light[0][0][0] == 0):
                ...
                for i in range(10):
                    ...
                    reward2 += traci.edge.getLastStepHaltingNumber(
                        '2si') + traci.edge.getLastStepHaltingNumber('1si')
                    traci.trafficlight.setPhase('gneJ15', 0)
                    waiting_time += (traci.edge.getLastStepHaltingNumber('a') + traci.edge.getLastStepHaltingNumber(
                        'c') + traci.edge.getLastStepHaltingNumber('e') + traci.edge.getLastStepHaltingNumber('g')+traci.edge.getLastStepHaltingNumber('f') + traci.edge.getLastStepHaltingNumber(
                        'k') + traci.edge.getLastStepHaltingNumber('i') + traci.edge.getLastStepHaltingNumber('m'))
                    traci.simulationStep()
            ...
            if(action == 1 and light[0][0][0] == 1):
                for i in range(6):
                    stepz += 1
                    traci.trafficlight.setPhase('gneJ15', 5)
                    waiting_time += (traci.edge.getLastStepHaltingNumber('a') + traci.edge.getLastStepHaltingNumber(
                        'c') + traci.edge.getLastStepHaltingNumber('e') + traci.edge.getLastStepHaltingNumber('g')+traci.edge.getLastStepHaltingNumber('f') + traci.edge.getLastStepHaltingNumber(
                        'k') + traci.edge.getLastStepHaltingNumber('i') + traci.edge.getLastStepHaltingNumber('m'))
                    traci.simulationStep()
                for i in range(10):
                    stepz += 1
                    traci.trafficlight.setPhase('gneJ151', 6)
                   waiting_time += (traci.edge.getLastStepHaltingNumber('a') + traci.edge.getLastStepHaltingNumber(
                        'c') + traci.edge.getLastStepHaltingNumber('e') + traci.edge.getLastStepHaltingNumber('g')+traci.edge.getLastStepHaltingNumber('f') + traci.edge.getLastStepHaltingNumber(
                        'k') + traci.edge.getLastStepHaltingNumber('i') + traci.edge.getLastStepHaltingNumber('m'))
                    traci.simulationStep()
                for i in range(6):
                    stepz += 1
                    traci.trafficlight.setPhase('gneJ15', 7)
                    waiting_time += (traci.edge.getLastStepHaltingNumber('a') + traci.edge.getLastStepHaltingNumber(
                        'c') + traci.edge.getLastStepHaltingNumber('e') + traci.edge.getLastStepHaltingNumber('g')+traci.edge.getLastStepHaltingNumber('f') + traci.edge.getLastStepHaltingNumber(
                        'k') + traci.edge.getLastStepHaltingNumber('i') + traci.edge.getLastStepHaltingNumber('m'))
                    traci.simulationStep()
...
if __name__ == '__main__':
    ...
    for e in range(episodes):
        ...
        traci.trafficlight.setPhase("gneJ15", 0)
        traci.trafficlight.setPhaseDuration("gneJ15", 200)
